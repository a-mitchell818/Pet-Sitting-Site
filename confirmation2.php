...
<html lang="en">
    ...
    <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPortfolio">
                                <a class="dropdown-item" href="portfolio-3-col.html">View All</a>
        ...
        <div class="container">
            ...
            <h1 class="mt-4 mb-3">Contact us Request
                <small></small>
            </h1>
            ...
            <!-- Contact Form with BREAKPOINTS-->
            <!-- In order to set the email address and subject line for the contact form go to the bin/contact_me.php file. -->
            <div class="row">
                 <!-- with BREAKPOINTS-->
                <div class="col-lg-8 col-sm-6 col-xs-12 mb-4">
                    <h3>Thank you for contacting Ronin Home Pet Care we will respond to your inquiry within 24-48 hours via email</h3>
                    <p>For additonal information about our company please go to our about us page </p>
                    <a href="http://lamp.cse.fau.edu/~amitch41/p4/about.html">About Us</a>
                </div>
